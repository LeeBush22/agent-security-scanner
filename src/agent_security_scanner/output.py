...
def render_welcome(console: Console | None = None, language: Language = Language.EN) -> None:
    ...
    right.add_row("  output/en/report.md")
    right.add_row("  output/zh/report.md")
    right.add_row("  output/en/report.xlsx")
    right.add_row("  output/zh/report.xlsx")
    right.add_row("  output/en/report.pdf")
    right.add_row("  output/zh/report.pdf")
