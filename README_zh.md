...
在交互式菜单中，“扫描当前目录”指的是你当前终端所在的目录。如果提示你输入“项目目录”，直接回车或输入 `.` 都表示当前目录；如果要扫描其他项目，则输入那个项目的完整路径。不要输入“当前”两个字，因为工具会把它当作一个真实文件夹名。
...
完整 V1.0.0 发布检查清单见 `docs/RELEASE_CHECKLIST.md`。发布文案、GitHub Topics 和传播材料见 `docs/LAUNCH.md`。
